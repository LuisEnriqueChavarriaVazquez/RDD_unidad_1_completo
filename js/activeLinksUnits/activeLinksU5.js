...
$(".navOptionsContent").on("click", function () {
    ...
    $(".navOptionsContent").removeClass("activeLinkOptionsContentUnit5");
    $(this).addClass("activeLinkOptionsContentUnit5");
...
$(".navOptionsContentMobileMenu").on("click", function () {
    ...
    $(".navOptionsContentMobileMenu").removeClass("activeLinkOptionsContentUnit5Mobile");
    $(this).addClass("activeLinkOptionsContentUnit5Mobile");
