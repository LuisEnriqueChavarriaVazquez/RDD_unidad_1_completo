...
$(".navOptionsContent").on("click", function () {
    ...
    $(".navOptionsContent").removeClass("activeLinkOptionsContentUnit2");
    $(this).addClass("activeLinkOptionsContentUnit2");
...
$(".navOptionsContentMobileMenu").on("click", function () {
    ...
    $(".navOptionsContentMobileMenu").removeClass("activeLinkOptionsContentUnit2Mobile");
    $(this).addClass("activeLinkOptionsContentUnit2Mobile");
