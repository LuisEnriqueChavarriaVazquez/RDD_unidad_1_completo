...
$(".navOptionsContent").on("click", function () {
    ...
    $(".navOptionsContent").removeClass("activeLinkOptionsContentUnit4");
    $(this).addClass("activeLinkOptionsContentUnit4");
...
$(".navOptionsContentMobileMenu").on("click", function () {
    ...
    $(".navOptionsContentMobileMenu").removeClass("activeLinkOptionsContentUnit4Mobile");
    $(this).addClass("activeLinkOptionsContentUnit4Mobile");
